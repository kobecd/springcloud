...
//    @ApiOperation(value = "屏端,分页条件查询显示商品列表", notes = "注意分页、是否有参数分组code，返回产品列表")
//    public ResponseVO selectProductsByRFIDCode(@RequestBody ProductDTO query) {
//        log.debug("参数 query {}", query);
