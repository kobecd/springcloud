...
import com.rongyi.dto.hudao.ExtGroupDTO;
import com.rongyi.dto.hudao.HuDaoProductSpuDTO;
import com.rongyi.dto.hudao.PageDTO;
import com.rongyi.dto.query.HuDaoQueryDTO;
...
public class SpuAgent {
    ...
    public PullLog syncSpus() {
        ...
        if (LocalSpuTotal == 0) {//全量同步
            ...
            log.debug("开始时间startDate {}", bdPullLog.getRequestDate());
