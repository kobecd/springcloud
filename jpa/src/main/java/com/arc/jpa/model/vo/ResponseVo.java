...
//    private boolean success;
    ...
    //success方法
    public static <T> com.arc.model.vo.ResponseVo<T> success() {
        return new com.arc.model.vo.ResponseVo<T>(ContextCode.SUCCESS.getCode(), ContextCode.SUCCESS.getMsg(), null);
    }

    public static <T> com.arc.model.vo.ResponseVo<T> success(T data) {
        return new com.arc.model.vo.ResponseVo<T>(ContextCode.SUCCESS.getCode(), ContextCode.SUCCESS.getMsg(), data);
    }

    public static <T> com.arc.model.vo.ResponseVo<T> success(ContextCode enumCode) {
        return new com.arc.model.vo.ResponseVo<T>(enumCode.getCode(), enumCode.getMsg(), null);
    }

    public static <T> com.arc.model.vo.ResponseVo<T> success(ContextCode enumCode, T data) {
        return new com.arc.model.vo.ResponseVo<T>(enumCode.getCode(), enumCode.getMsg(), data);
    }

    //失败
    public static <T> com.arc.model.vo.ResponseVo<T> failure(ContextCode enumCode) {
        return new com.arc.model.vo.ResponseVo<T>(enumCode.getCode(), enumCode.getMsg(),  null);
    }

    public static <T> com.arc.model.vo.ResponseVo<T> failure(T data) {
        return new com.arc.model.vo.ResponseVo<T>(ContextCode.FAILURE.getCode(), ContextCode.FAILURE.getMsg(),  data);
    }

    public static <T> com.arc.model.vo.ResponseVo<T> failure(ContextCode enumCode, T data) {
        return new com.arc.model.vo.ResponseVo<T>(enumCode.getCode(), enumCode.getMsg(),  data);
    }

    public static com.arc.model.vo.ResponseVo failure() {
        return new com.arc.model.vo.ResponseVo(ContextCode.FAILURE);
    }
