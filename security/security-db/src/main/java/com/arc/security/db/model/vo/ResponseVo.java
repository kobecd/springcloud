package com.arc.security.db.model.vo;

import com.arc.security.db.model.enums.ProjectCode;
...
public class ResponseVo<T> implements Serializable {
    ...
    public static <T> ResponseVo<T> success() {
        return new ResponseVo<T>(ProjectCode.SUCCESS.getCode(), ProjectCode.SUCCESS.getMsg(), Boolean.TRUE, null);
    }

    public static <T> ResponseVo<T> success(T data) {
        return new ResponseVo<T>(ProjectCode.SUCCESS.getCode(), ProjectCode.SUCCESS.getMsg(), Boolean.TRUE, data);
    }
    ...
    public static <T> ResponseVo<T> failure(T data) {
        return new ResponseVo<T>(ProjectCode.FAILURE.getCode(), ProjectCode.FAILURE.getMsg(), Boolean.FALSE, data);
    }
