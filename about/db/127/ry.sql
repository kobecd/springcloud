...
CREATE TABLE `activity_base_info` (
  ...
  `resource_url` varchar(128) DEFAULT NULL COMMENT '资源包地址',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=67 DEFAULT CHARSET=utf8 COMMENT='活动基本信息';

-- ----------------------------
-- Records of activity_base_info
-- ----------------------------
INSERT INTO `activity_base_info` VALUES ('20', '33', '1', null, '123', '', '54f403eae4b002000cf63762', '雄楚一号', '1', '', '15', 'http://www.baidu.com', '1', '2018-06-11 00:00:00', '2018-07-25 00:00:00', '1', '2018-07-31 11:46:17', '', '2018-07-31 11:46:17', 'superadmin');
...
INSERT INTO `activity_base_info` VALUES ('65', '45', '1', null, 'sdfsdf', '', '54f403eae4b002000cf63762', '雄楚一号', '1', '', '1', '', '31', '2018-07-17 00:00:00', '2018-07-28 00:00:00', '1', '2018-07-24 14:56:01', 'superadmin', '2018-07-17 18:40:43', 'superadmin');
INSERT INTO `activity_base_info` VALUES ('66', '46', '1', null, '赛车很反感发', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180731/2418e8c3a1a9fc6d6da175fdbd00fd32.jpg', '54f403eae4b002000cf63762', '雄楚一号', '3', '', '32', 'http://hf.rongyi.com/o2o/h5/lining/car/index.html', '45', '2018-07-25 00:00:00', '2019-08-03 00:00:00', '2', '2018-08-03 17:08:52', 'superadmin', '2018-08-03 17:08:52', 'superadmin');
...
CREATE TABLE `activity_cast_multi_screen` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8 COMMENT='多屏互动投放记录表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='标准活动小时汇总数据表';
...
CREATE TABLE `activity_notice_template` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=50 DEFAULT CHARSET=utf8 COMMENT='通知模板配置表';
...
INSERT INTO `activity_notice_template` VALUES ('48', '66', '153', '0', '');
INSERT INTO `activity_notice_template` VALUES ('49', '66', '154', '0', '');

-- ----------------------------
-- Table structure for `activity_operate_log`
-- ----------------------------
DROP TABLE IF EXISTS `activity_operate_log`;
CREATE TABLE `activity_operate_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `activity_id` int(11) DEFAULT NULL,
  `op_type` int(4) DEFAULT NULL COMMENT '1:新增  2：修改  3：删除',
  `field_compare_results` varchar(500) DEFAULT NULL COMMENT '字段对比结果',
...
-- ----------------------------
-- Records of activity_operate_log
-- ----------------------------
INSERT INTO `activity_operate_log` VALUES ('25', '66', '2', '[{\"fieldEnName\":\"maxPeople\",\"fieldName\":\"参与条件限制 最多参与人数\",\"id\":null,\"operateType\":2,\"original\":0,\"target\":1}]', '2018-08-02 16:43:46', 'superadmin');
INSERT INTO `activity_operate_log` VALUES ('26', '66', '2', '[{\"fieldEnName\":\"singleMaxWinning\",\"fieldName\":\"领奖设置 单用户最多可抽到次数\",\"id\":null,\"operateType\":2,\"original\":0,\"target\":10},{\"fieldEnName\":\"initialTimes\",\"fieldName\":\"高级设置 初始次数\",\"id\":null,\"operateType\":2,\"original\":0,\"target\":10}]', '2018-08-03 17:08:52', 'superadmin');
...
CREATE TABLE `activity_prize` (
  ...
  `discover_type` int(4) DEFAULT NULL COMMENT '开奖类型',
  `min_score` int(11) DEFAULT NULL COMMENT '最小值',
  `max_score` int(11) DEFAULT NULL COMMENT '最大值',
  `update_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
  KEY `idx_activity_id` (`activity_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=155 DEFAULT CHARSET=utf8 COMMENT='活动奖品规则';

-- ----------------------------
-- Records of activity_prize
-- ----------------------------
INSERT INTO `activity_prize` VALUES ('101', '20', '1', 'games1', null, '1', '5af4fc8b6bcb4a07ba8e9b72', '卡券games', '0', null, null, null, '22', '18', '1', null, null, null, null, null, '2018-07-31 11:47:06');
INSERT INTO `activity_prize` VALUES ('114', '25', 'prizeLevel', 'prizeName', null, '1', 'objId', 'objName', null, null, null, null, '10', '5', '1', null, null, null, null, null, '2018-07-20 14:44:00');
INSERT INTO `activity_prize` VALUES ('115', '33', '3', '3', null, '2', '', '会员积分1', '1', null, null, null, '1', '1', '1', null, null, null, null, null, '2018-07-04 13:53:36');
INSERT INTO `activity_prize` VALUES ('116', '35', '', '微信红包1', null, '3', '', '微信红包1', '1', null, null, null, '6000', '5990', '1', null, null, null, null, null, '2018-06-04 19:58:02');
INSERT INTO `activity_prize` VALUES ('117', '36', '', '微信红包1', '', '3', '', '微信红包1', '1', '', '0', null, '6000', '6000', '0', null, '1', null, null, null, '2018-06-05 13:38:05');
INSERT INTO `activity_prize` VALUES ('124', '37', '', '微信红包1', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180605/26ea734ebf8d9f8810aea8aaa9a37e09.png', '3', '', '微信红包1', '100', '', '0', null, '1300', '1276', '0', null, null, null, null, null, '2018-06-05 21:54:04');
INSERT INTO `activity_prize` VALUES ('125', '37', '', '微信红包2', '', '3', '', '微信红包2', '200', '', '0', null, '1000', '984', '0', null, null, null, null, null, '2018-06-05 21:54:04');
INSERT INTO `activity_prize` VALUES ('126', '37', '', '微信红包5', '', '3', '', '微信红包5', '500', '', '0', null, '150', '148', '0', null, null, null, null, null, '2018-06-05 21:54:04');
INSERT INTO `activity_prize` VALUES ('127', '37', '', '微信红包8', '', '3', '', '微信红包8', '800', '', '0', null, '100', '97', '0', null, null, null, null, null, '2018-06-05 21:54:04');
INSERT INTO `activity_prize` VALUES ('128', '37', '', '微信红包10', '', '3', '', '微信红包10', '1000', '', '0', null, '80', '80', '0', null, null, null, null, null, '2018-06-05 21:54:04');
INSERT INTO `activity_prize` VALUES ('129', '37', '', '微信红包18', '', '3', '', '微信红包18', '1800', '', '0', null, '50', '50', '0', null, null, null, null, null, '2018-06-05 21:54:04');
INSERT INTO `activity_prize` VALUES ('131', '38', '', '微信红包1', '', '3', '', '微信红包1', '100', '', '0', null, '1000', '878', '1', null, null, null, null, null, '2018-06-07 15:36:35');
INSERT INTO `activity_prize` VALUES ('132', '39', '', '文案恭喜你中', '', '4', '', '文案恭喜你中', '0', '恭喜你中了奖', '0', null, '0', '0', '0', null, null, null, null, null, '2018-06-11 13:58:59');
INSERT INTO `activity_prize` VALUES ('133', '40', '', '文案恭喜你中', '', '4', '', '文案恭喜你中', '0', '恭喜你中间两个', '0', null, '100', '98', '10', null, null, null, null, null, '2018-07-09 17:43:25');
INSERT INTO `activity_prize` VALUES ('134', '42', '', '文案中奖了', '', '4', '', '文案中奖了', '0', '中奖了', '0', null, '0', '0', '0', null, null, null, null, null, '2018-06-11 17:54:21');
INSERT INTO `activity_prize` VALUES ('135', '50', '', '会员积分1', '', '2', '', '会员积分1', '0', '', '1', null, '1', '1', '0', null, null, null, null, null, '2018-06-13 15:03:53');
INSERT INTO `activity_prize` VALUES ('136', '51', '', '文案测试', '', '4', '', '文案测试', '0', '测试', '0', null, '100', '100', '0', null, null, null, null, null, '2018-06-22 16:12:13');
INSERT INTO `activity_prize` VALUES ('137', '52', '', '文案test', '', '4', '', '文案test', '0', 'test', '0', null, '2', '2', '0', null, null, null, null, null, '2018-06-22 16:16:28');
INSERT INTO `activity_prize` VALUES ('138', '53', '', '文案test', '', '4', '', '文案test', '0', 'test', '0', null, '2', '2', '0', null, null, null, null, null, '2018-06-22 16:18:07');
INSERT INTO `activity_prize` VALUES ('139', '54', '', '文案test', '', '4', '', '文案test', '0', 'test', '0', null, '2', '2', '0', null, null, null, null, null, '2018-06-22 16:18:11');
INSERT INTO `activity_prize` VALUES ('140', '55', '', '文案test', '', '4', '', '文案test', '0', 'test', '0', null, '2', '2', '0', null, null, null, null, null, '2018-06-22 16:18:13');
INSERT INTO `activity_prize` VALUES ('141', '56', '', '文案test', '', '4', '', '文案test', '0', 'test', '0', null, '2', '2', '0', null, null, null, null, null, '2018-06-22 16:18:15');
INSERT INTO `activity_prize` VALUES ('142', '57', '', '文案test', '', '4', '', '文案test', '0', 'test', '0', null, '2', '2', '0', null, null, null, null, null, '2018-06-28 10:26:36');
INSERT INTO `activity_prize` VALUES ('143', '58', '', '卡券', '', '5', '10692', '卡券', '0', '', '0', null, '100', '78', '1', null, null, null, null, null, '2018-06-28 17:29:13');
INSERT INTO `activity_prize` VALUES ('144', '59', '', '文案test', '', '4', '', '文案test', '0', 'test', '0', null, '2', '2', '0', null, null, null, null, null, '2018-07-04 15:11:13');
INSERT INTO `activity_prize` VALUES ('145', '40', '', '文案文案奖品', '', '4', '', '文案文案奖品', '0', '文案奖品01', '0', null, '100', '100', '20', null, null, null, null, null, '2018-07-09 17:43:25');
INSERT INTO `activity_prize` VALUES ('146', '40', '', '新卡券红桃K-卡券测试12', '', '5', '100101', '新卡券红桃K-卡券测试12', '0', '', '0', null, '10', '10', '0', null, null, null, null, null, '2018-07-09 17:43:25');
INSERT INTO `activity_prize` VALUES ('147', '60', '', '新卡券红桃K-卡券测试12', '', '5', '100101', '新卡券红桃K-卡券测试12', '0', '', '0', null, '0', '0', '0', null, null, null, null, null, '2018-07-17 18:40:21');
INSERT INTO `activity_prize` VALUES ('148', '61', '', '新卡券卡券名称', '', '5', '100130', '新卡券卡券名称', '0', '', '0', null, '10', '10', '0', null, null, null, null, null, '2018-07-11 15:51:01');
INSERT INTO `activity_prize` VALUES ('149', '62', '', '文案你是谁', '', '4', '', '文案你是谁', '0', '你是谁', '0', null, '0', '0', '0', null, null, null, null, null, '2018-07-11 15:52:52');
INSERT INTO `activity_prize` VALUES ('150', '63', '', '文案dsad', '', '4', '', '文案dsad', '0', 'dsadsad', '0', null, '0', '0', '0', null, null, null, null, null, '2018-07-16 15:43:43');
INSERT INTO `activity_prize` VALUES ('151', '64', '', '文案dsad', '', '4', '', '文案dsad', '0', 'dsadsad', '0', null, '10', '10', '100', null, null, null, null, null, '2018-07-24 14:54:15');
INSERT INTO `activity_prize` VALUES ('152', '65', '', '文案你好，我', '', '4', '', '文案你好，我', '0', '你好，我是文案', '0', '8', '10', '1', '1', null, null, null, null, null, '2018-07-24 18:57:10');
INSERT INTO `activity_prize` VALUES ('154', '66', '2222', '888', '', '2', '', '会员积分', '100', '6666', '1', null, '0', '0', '0', '1', '1', '2', '12', '111', '2018-08-03 17:08:52');
...
CREATE TABLE `activity_rule` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=54 DEFAULT CHARSET=utf8 COMMENT='活动参与规则';

-- ----------------------------
-- Records of activity_rule
-- ----------------------------
INSERT INTO `activity_rule` VALUES ('15', '20', null, null, null, null, null, null, null, null, null, null, null, '0');
...
INSERT INTO `activity_rule` VALUES ('52', '65', '{\"integrals\":0,\"memberLimitType\":1,\"memberType\":1,\"needIntegrals\":false,\"needLogin\":false,\"needWechat\":true,\"wechatLimitType\":1}', null, null, null, '100', '{\"addTimes\":0,\"addTimesType\":0,\"initialTimes\":10,\"maxAddTimes\":0,\"point\":0}', '', null, null, '0', '1', '0');
INSERT INTO `activity_rule` VALUES ('53', '66', '{\"integrals\":1,\"memberLimitType\":1,\"memberType\":1,\"needIntegrals\":false,\"needLogin\":false,\"needWechat\":true,\"wechatLimitType\":1}', '1', '0', '11', '1', '{\"addTimes\":0,\"addTimesType\":0,\"initialTimes\":10,\"maxAddTimes\":0,\"point\":0}', '', '10', '0', '0', '1', '0');

-- ----------------------------
-- Table structure for `activity_skin_bag`
-- ----------------------------
DROP TABLE IF EXISTS `activity_skin_bag`;
CREATE TABLE `activity_skin_bag` (
  ...
  `status` int(4) DEFAULT '0' COMMENT '0正常， 1删除',
  `create_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
  `create_by` varchar(255) NOT NULL DEFAULT '' COMMENT '创建人',
  `update_at` timestamp NULL DEFAULT NULL COMMENT '更新时间',
  `update_by` varchar(255) DEFAULT '' COMMENT '最后更新人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8 COMMENT='皮肤包';

-- ----------------------------
-- Records of activity_skin_bag
-- ----------------------------
INSERT INTO `activity_skin_bag` VALUES ('1', '皮肤1', null, 'h5Skinurl', 'dsaasd', 'dadas', '1', '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('2', '皮肤2', null, 'h5Skinurl', 'dsaasd', 'dadas', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('3', '皮肤1', null, 'h5Skinurl', 'dsaasd', 'dadas', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('4', '皮肤1', null, 'h5Skinurl', 'dsaasd', 'dadas', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('5', '皮肤1', null, 'h5Skinurl', 'dsaasd', 'dadas', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('6', '皮肤1', null, 'h5Skinurl', 'dsaasd', 'dadas', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('7', '皮肤1', null, 'h5Skinurl', 'dsaasd', 'dadas', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('8', '皮肤1', null, 'h5Skinurl', 'dsaasd', 'dadas', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('9', '皮肤1', null, 'h5Skinurl', 'dsaasd', 'dadas', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('10', '皮肤1', null, 'h5Skinurl', 'dsaasd', 'dadas', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('11', '皮肤1', null, 'h5Skinurl', 'dsaasd', 'dadas', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('12', '皮肤1', null, 'h5Skinurl', 'dsaasd', 'dadas', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('13', '皮肤1', null, 'h5Skinurl', 'dsaasd', 'dadas', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('14', '皮肤1', null, 'h5Skinurl', 'dsaasd', 'dadas', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('15', '皮肤1', null, 'h5Skinurl', 'dsaasd', 'dadas', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('16', '皮肤3', '33', 'http://wewewewe', 'http://sdfsdfsdf', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180706/153aefec3b39f4c1f0c84bcf375813c8.png', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('17', 'sdf', '33', 'http://sdfasdf', 'http://sdfsdf', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180706/b472e48ad245f8228d8ba121f01dd9cd.png', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('18', 'sdfasdf', '33', 'http://wersdf', 'http://sdfsdf', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180706/f0e391fba48154eab9744ac3c0f83506.png', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('19', 'add1', '33', 'http://www.baidu.com', 'http://www.baidu.com', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180709/d1d9387d06ba47685907de3d43a53898.png', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('20', 'add2', '33', 'http://www.baidu.com', 'http://www.baidu.com', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180709/8fccebdb2bc7151c12bf4a1f2747ab1d.png', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('21', 'add3', '33', 'http://www.baidu.com', 'http://www.baidu.com', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180709/5aba80f7f82bab20e85fd5d9449385a5.png', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('22', '测试皮肤1', '42', 'http://www.baidu.com', 'http://www.baidu.com', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180710/0d20f73077adbdd6f781aef0f3809f5a.png', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('25', 'ceshi', '45', 'http://www.baidu.com', '', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180710/b106d9fbcba1b16fa8145bbd10b5f85b.png', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('26', '424', '45', 'http://www.rongyi.com', '', '', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('27', '你好，我没上传图', '45', 'http://rongyi.b0.upaiyun.com/activity/skin/c11d68f78577b8aa31a1c462c4404f37', '', '', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('28', '没图', '45', 'http://www.rongyi.com', '', '', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('29', '100', '45', 'http://rongyi.b0.upaiyun.com/activity/skin/e1417316ea277eedb4a4a1cede5fec68', '', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180622/2ba0dd49520db6e13d12c2e0277434c8.png', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('30', '101', '45', 'http://rongyi.b0.upaiyun.com/activity/skin/1b7685df0c0dd2325f07718f7e26be9c', '', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180622/2ba0dd49520db6e13d12c2e0277434c8.png', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('31', '102', '45', 'http://rongyi.b0.upaiyun.com/activity/skin/dfca9719e990eff91268cd8ec92fda05', '', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180622/2ba0dd49520db6e13d12c2e0277434c8.png', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('32', '103', '45', 'http://rongyi.b0.upaiyun.com/activity/skin/a657ed5c38cafdf79da3f4fb39d3ea40', '', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180622/2ba0dd49520db6e13d12c2e0277434c8.png', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('33', 'asdf', '45', 'http://afadfsdf', '', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180622/2ba0dd49520db6e13d12c2e0277434c8.png', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('34', 'asdf', '45', 'http://adf', '', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180622/2ba0dd49520db6e13d12c2e0277434c8.png', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('35', 'sdf', '45', 'http://asdfsdf', '', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180622/2ba0dd49520db6e13d12c2e0277434c8.png', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('36', 'sdfsf', '45', 'http://asdfsdf', '', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180622/2ba0dd49520db6e13d12c2e0277434c8.png', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('37', 'sdfsdf', '45', 'http://asdfsdfsdf', '', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180622/2ba0dd49520db6e13d12c2e0277434c8.png', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('38', 'sdf', '45', 'http://sadf', '', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180622/2ba0dd49520db6e13d12c2e0277434c8.png', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('39', 'asdf', '45', 'http://asdf', '', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180622/2ba0dd49520db6e13d12c2e0277434c8.png', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('40', '赛车赛马', '46', '', 'http://hf.rongyi.com/o2o/h5/lining/car/index.html', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180731/15bace2877c2170b81dc3ddf3db213d7.jpg', null, '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('41', '232323', '46', 'http://hf.rongyi.com/o2o/h5/lining/car/index.html', 'http://hf.rongyi.com/o2o/h5/lining/car/index.html', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180731/4d5b49fd536ae1da39ebc7cae7f058f5.jpg', '0', '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('42', '111111', '46', 'http://hf.rongyi.com/o2o/h5/lining/car/index.html', 'http://hf.rongyi.com/o2o/h5/lining/car/index.html', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180731/4d5b49fd536ae1da39ebc7cae7f058f5.jpg', '0', '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('43', '111111', '46', 'http://hf.rongyi.com/o2o/h5/lining/car/index.html', 'http://hf.rongyi.com/o2o/h5/lining/car/index.html', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180731/4d5b49fd536ae1da39ebc7cae7f058f5.jpg', '1', '2018-08-03 14:14:50', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('44', '11111', '46', 'http://hf.rongyi.com/o2o/h5/lining/car/index.html', 'http://hf.rongyi.com/o2o/h5/lining/car/index.html', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180731/4d5b49fd536ae1da39ebc7cae7f058f5.jpg', '0', '0000-00-00 00:00:00', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('45', '11111', '46', 'http://hf.rongyi.com/o2o/h5/lining/car/index.html', 'http://hf.rongyi.com/o2o/h5/lining/car/index.html', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180731/4d5b49fd536ae1da39ebc7cae7f058f5.jpg', '1', '2018-08-03 14:09:03', '', null, '');
INSERT INTO `activity_skin_bag` VALUES ('46', '1111111', '46', 'http://hf.rongyi.com/o2o/h5/lining/car/index.html', 'http://hf.rongyi.com/o2o/h5/lining/car/index.html', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180731/4d5b49fd536ae1da39ebc7cae7f058f5.jpg', '0', '2018-08-03 15:00:51', 'superadmin', '2018-08-03 15:00:51', 'superadmin');
INSERT INTO `activity_skin_bag` VALUES ('47', '222', '46', 'http://hf.rongyi.com/o2o/h5/lining/car/index.html', 'http://hf.rongyi.com/o2o/h5/lining/car/index.html', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180803/038f742ac8b1a4a60eea5d99745a4058.png', '0', '2018-08-03 15:01:38', 'superadmin', '2018-08-03 15:01:38', 'superadmin');
INSERT INTO `activity_skin_bag` VALUES ('48', '啥大事', '45', 'http://rongyi.b0.upaiyun.com/activity/skin/670338be82b81f756e6831fc61af992b', '', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180622/2ba0dd49520db6e13d12c2e0277434c8.png', '0', '2018-08-03 16:48:12', 'superadmin', '2018-08-03 16:48:12', 'superadmin');
...
-- ----------------------------
INSERT INTO `auction_dayuecheng_goods` VALUES ('4', '今天', 'http://pic.616pic.com/ys_img/00/13/06/9RARz0JNMe.jpg', '123.00', '1', '2018-07-24 00:00:00', '2018-07-25 11:00:03', '0IqFYYJnZQ+x30AWxppKZcjtc9AsxxQlV3F3nvQMlDA=', '2018-07-19 11:00:03', '1', null, '2018-07-24 10:23:55');
INSERT INTO `auction_dayuecheng_goods` VALUES ('6', '本周一', 'http://pic.616pic.com/ys_img/00/13/06/9RARz0JNMe.jpg', '200.00', '1', '2018-07-24 18:23:04', '2018-07-25 16:48:38', '0IqFYYJnZQ+x30AWxppKZcjtc9AsxxQlV3F3nvQMlDA=', '2018-07-16 15:43:36', '0', null, '2018-07-24 10:24:55');
...
CREATE TABLE `frog_zhengjia_activity_record` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8 COMMENT='青蛙活动消息扩展表';
...
INSERT INTO `frog_zhengjia_activity_record` VALUES ('5', '49', '166', '正佳广场', '2018-07-18 14:48:37');
INSERT INTO `frog_zhengjia_activity_record` VALUES ('6', '64', '169', '组织者9', '2018-07-24 11:31:18');
INSERT INTO `frog_zhengjia_activity_record` VALUES ('7', '64', '0', '组织者9', '2018-07-24 11:31:33');
INSERT INTO `frog_zhengjia_activity_record` VALUES ('8', '64', '0', '组织者9', '2018-07-24 11:35:32');
INSERT INTO `frog_zhengjia_activity_record` VALUES ('9', '64', '170', '组织者9', '2018-07-24 11:46:05');
INSERT INTO `frog_zhengjia_activity_record` VALUES ('10', '64', '171', '组织者9', '2018-07-24 11:46:06');
INSERT INTO `frog_zhengjia_activity_record` VALUES ('11', '64', '172', '组织者9', '2018-07-24 11:46:20');
INSERT INTO `frog_zhengjia_activity_record` VALUES ('12', '64', '173', '正佳广场', '2018-07-24 11:46:21');
INSERT INTO `frog_zhengjia_activity_record` VALUES ('13', '64', '174', '正佳广场', '2018-07-24 11:46:22');
INSERT INTO `frog_zhengjia_activity_record` VALUES ('14', '64', '175', '正佳广场', '2018-07-24 14:51:40');
INSERT INTO `frog_zhengjia_activity_record` VALUES ('15', '65', '171', '正佳广场', '2018-07-24 14:57:45');
INSERT INTO `frog_zhengjia_activity_record` VALUES ('16', '65', '172', '正佳广场', '2018-07-24 14:58:15');
INSERT INTO `frog_zhengjia_activity_record` VALUES ('17', '65', '173', '正佳广场好', '2018-07-24 15:05:55');
INSERT INTO `frog_zhengjia_activity_record` VALUES ('18', '65', '174', '正佳广场好', '2018-07-24 15:20:56');
INSERT INTO `frog_zhengjia_activity_record` VALUES ('19', '65', '175', '正佳广场好', '2018-07-24 15:21:58');
INSERT INTO `frog_zhengjia_activity_record` VALUES ('20', '65', '1', '正佳广场好', '2018-07-24 15:22:45');
INSERT INTO `frog_zhengjia_activity_record` VALUES ('21', '65', '1', '正佳广场好', '2018-07-24 15:27:52');
INSERT INTO `frog_zhengjia_activity_record` VALUES ('22', '65', '2', 'AAA正佳广场好', '2018-07-24 15:30:00');
INSERT INTO `frog_zhengjia_activity_record` VALUES ('23', '65', '1', 'AAA正佳广场好', '2018-07-24 15:32:27');
INSERT INTO `frog_zhengjia_activity_record` VALUES ('24', '65', '2', 'BBBBBBBBBBB', '2018-07-24 15:34:58');
INSERT INTO `frog_zhengjia_activity_record` VALUES ('25', '65', '1', '111111', '2018-07-24 15:48:05');
INSERT INTO `frog_zhengjia_activity_record` VALUES ('26', '65', '2', '收到所担任法官说的的方式', '2018-07-24 15:58:40');
INSERT INTO `frog_zhengjia_activity_record` VALUES ('27', '65', '3', '正佳广场', '2018-07-24 16:03:38');
INSERT INTO `frog_zhengjia_activity_record` VALUES ('28', '65', '4', '正佳广场', '2018-07-24 16:08:47');
INSERT INTO `frog_zhengjia_activity_record` VALUES ('29', '65', '5', '正佳广场', '2018-07-24 16:09:26');
INSERT INTO `frog_zhengjia_activity_record` VALUES ('30', '65', '6', 'DDD正佳广场', '2018-07-24 16:09:30');
INSERT INTO `frog_zhengjia_activity_record` VALUES ('31', '65', '7', '正佳广场', '2018-07-24 16:11:40');
INSERT INTO `frog_zhengjia_activity_record` VALUES ('32', '65', '8', '正佳广场', '2018-07-24 16:26:35');
...
CREATE TABLE `frog_zhengjia_activity_record_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='人工修改青蛙活动操作流水记录表';
...
INSERT INTO `frog_zhengjia_activity_record_log` VALUES ('14', '49', null, '0', '11', '2018-07-24 10:07:47');
INSERT INTO `frog_zhengjia_activity_record_log` VALUES ('15', '49', null, '11', '11', '2018-07-24 10:07:58');
INSERT INTO `frog_zhengjia_activity_record_log` VALUES ('16', '49', null, '22', '2', '2018-07-24 10:08:11');
INSERT INTO `frog_zhengjia_activity_record_log` VALUES ('17', '49', null, '24', '2', '2018-07-24 10:08:30');
INSERT INTO `frog_zhengjia_activity_record_log` VALUES ('18', '49', null, '26', '2', '2018-07-24 11:04:16');
INSERT INTO `frog_zhengjia_activity_record_log` VALUES ('19', '65', null, '0', '2', '2018-07-24 16:23:04');
INSERT INTO `frog_zhengjia_activity_record_log` VALUES ('20', '65', null, '2', '2', '2018-07-24 16:23:14');
INSERT INTO `frog_zhengjia_activity_record_log` VALUES ('21', '65', null, '4', '2', '2018-07-24 16:26:29');
...
CREATE TABLE `guess_record` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 COMMENT='竞猜结果记录表';
...
CREATE TABLE `play_record_base_001` (
  ...
  `create_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='活动基础表';
...
CREATE TABLE `play_record_base_002` (
  ...
  `create_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COMMENT='活动基础表';

-- ----------------------------
-- Records of play_record_base_002
-- ----------------------------
INSERT INTO `play_record_base_002` VALUES ('1', '65', null, '11111', '1111', null, null, null, '1', '2018-07-24 15:48:05');
INSERT INTO `play_record_base_002` VALUES ('2', '65', null, 'OPEN1', null, null, null, null, '1', '2018-07-24 15:58:41');
INSERT INTO `play_record_base_002` VALUES ('3', '65', null, 'DD', null, null, null, null, '1', '2018-07-24 16:03:38');
INSERT INTO `play_record_base_002` VALUES ('4', '65', null, 'DD', null, null, null, null, '1', '2018-07-24 16:08:47');
INSERT INTO `play_record_base_002` VALUES ('5', '65', null, 'DD', null, null, null, null, '1', '2018-07-24 16:09:26');
INSERT INTO `play_record_base_002` VALUES ('6', '65', null, 'DD', null, null, null, null, '1', '2018-07-24 16:09:30');
INSERT INTO `play_record_base_002` VALUES ('7', '65', null, 'DD', null, null, null, null, '1', '2018-07-24 16:11:40');
INSERT INTO `play_record_base_002` VALUES ('8', '65', null, 'DD', null, null, null, null, '1', '2018-07-24 16:26:35');
...
-- ----------------------------
-- Table structure for `scan_qr_code_record`
-- ----------------------------
DROP TABLE IF EXISTS `scan_qr_code_record`;
CREATE TABLE `scan_qr_code_record` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `activity_id` int(11) DEFAULT NULL COMMENT '活动编号',
  `merchant_id` varchar(255) DEFAULT NULL COMMENT '机器商场编号',
  `open_id` varchar(255) DEFAULT NULL COMMENT 'openId',
  `code_nick_name` varchar(255) DEFAULT NULL COMMENT 'BASE64 编码昵称',
  `head_img_url` varchar(255) DEFAULT NULL COMMENT '头像',
  `first_follow` tinyint(255) DEFAULT NULL COMMENT '是否首次关注',
  `key` varchar(255) DEFAULT NULL COMMENT 'key',
  `user_id` bigint(20) DEFAULT NULL COMMENT '用户ID',
  `mall` varchar(255) DEFAULT NULL COMMENT '商场名称',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='扫码记录表';

-- ----------------------------
-- Records of scan_qr_code_record
-- ----------------------------
...
CREATE TABLE `template` (
  ...
  `update_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8 COMMENT='活动模板';
...
INSERT INTO `template` VALUES ('46', '赛车赛马', '1', '3', 'http://dev.hdp.rongyi.com/123456789012345678901234/20180731/4d5b49fd536ae1da39ebc7cae7f058f5.jpg', 'http://hf.rongyi.com/o2o/h5/lining/car/index.html', 'http://hf.rongyi.com/o2o/h5/lining/car/index.html', 'http://hf.rongyi.com/o2o/h5/lining/horse/index.html', 'http://hf.rongyi.com/o2o/h5/lining/car/index.html', '', '1', '2018-07-31 10:46:58', 'superadmin', '', '2018-08-01 16:21:08');
