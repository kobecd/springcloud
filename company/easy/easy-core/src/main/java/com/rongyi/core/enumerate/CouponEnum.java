...
public enum  CouponEnum {
    ...
    ERROR_UNLOGIN(1020102, "请重新登录！"),
    ERROR_NO_IDENTITY(1020103, "对不起，您没有权限！"),
    ERROR_REQUEST_TYPE(1020104, "请求类型不对！"),
    ERROR_REQUEST_URL(1020105, "请求地址不存在！"),
    ERROR_NO_PARAM(1020106, "请求参数为空！"),
    ...
    ERROR_COUPON_RECEIVE(1021401,"你已领取该卡券，无需重复领取，可至卡包查看"),
    ERROR_COUPON_NOTEXSIT(1021402,"卡券不存在！"),
    ERROR_COUPON_NOTSTART(1021403,"卡券还未到领取时间！"),
    ERROR_COUPON_END(1021404,"卡券领取时间已结束！"),
    ERROR_COUPON_STOCK(1021405,"卡券已停止！"),
    ERROR_COUPON_UNCHECK(1021405,"卡券未审核通过！"),
