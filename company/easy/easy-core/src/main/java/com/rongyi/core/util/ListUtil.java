...
//	}
	...
	public static String changeList2String(List<?> original, String separator){
	...
	public static List<String> parseString2List(String original, String separator){
		if(StringUtils.isBlank(original)){
			return new ArrayList<>();
		}
		List<String> targetList = new ArrayList<>();
		for(String str: original.split(separator)){
	...
	public static List<Integer> parseString2IntegerList(String original, String separator){
		if(StringUtils.isBlank(original)){
			return new ArrayList<>();
		}
		...
		for(String str: original.split(separator)){
			if(StringUtils.isNotBlank(str)){
				targetList.add(Integer.parseInt(str));
			}
		}
		return targetList;
	}
