...
public enum CodeEnum {
    ...
    ERROR_USER_REGISTE_FAIL("-1113","注册用户失败~"),
	...
	ERROR_MCMC_PICNULL("-7016","商品图片为空，更新商品失败"),
     ...
     * 安卓标准版错误提示
     */
    ERROR_NO_MODULE("1700001", "该商场配置的应用不存在"),
    ERROR_MALL_MODULE("1700002", "该商场未配置应用信息"),
    ERROR_APPLY_RELEASE("1700003", "该商场配置的应用信息未发布"),
    ERROR_NO_MACHINE("1700004", "该商场没有使用中的终端设备"),
    ERROR_MACHINE_NO_APK("1700005", "请检查设备是否全部设置默认启动应用，请前往商家后台[应用中心-->启动应用]查看"),
    ERROR_MACHINE_NO_CSA("1700006", "该商场下存在设备配置了默认启动应用而未配置执行模板"),
    ERROR_BASE_VERSION("1700007", "基础服务版本号不能为空"),
    ERROR_NO_FACILITY("1700008","该商场未配置需要展示的公共设施"),
    ERROR_NO_SHOP_CATEGORY("1700009","该商场未配置店铺分类"),
    ERROR_SHOP_INFO("1700010",""),
    ERROR_FLOOR_INFO("1700011",""),
    ERROR_MALL("1700012","该商场不存在"),
    ERROR_EXIST_MACHINE("1700013","设备不存在"),
    ERROR_EXIST_APK("1700014","APK应用不存在"),
    ERRPR_BASE_APK_EDIT("1700015","上传基础服务或者系统服务应用不需要基础服务版本"),
    ERROR_MACHINE_NO_CODE("1700016", "设备编号不全,请查看是否完整"),
    
    /**
     * 广告管理错误提示
     */
    ERROR_ADVERT_NAME("1800001", "广告名称不能为空"),
    ERROR_ADVERT_NAME_REPET("1800002", "广告名称不能重复"),
    ERROR_ADVERT_NAME_LENGTH("1800003", "广告名称长度在30个字符以内"),
    ERROR_ADVERT_PUT_TIME("1800004", "广告投放时段不能为空"),
    ERROR_ADVERT_BROADCAST_TIME("1800005", "播放时长请填写大于0的整数"),
    ERROR_ADVERT_SOURCES("1800006", "广告关联素材不能为空"),
    ERROR_ADVERT_STYLE("1800007", "广告样式传值为空或不合法"),
    ERROR_ADVERT_TIME("1800008", "广告投放时段结束时间不能小于开始时间"),
    /**
     * 模板类目错误提示
     */
    ERROR_EXIST_CASE_CATEGORY_NAME("1900001", "该名称已存在,请重新输入"),
    ERROR_NOT_EXIST_CASE_CATEGORY("1900002", "模板类目不存在或已删除")
    ;
