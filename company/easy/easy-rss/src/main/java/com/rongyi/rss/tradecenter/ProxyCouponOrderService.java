...
import com.rongyi.easy.coupon.param.CouponOrderLimitParam;
...
public interface ProxyCouponOrderService {
     ...
     *  用于卡券支付时 判断限购
     *
     * @param couponOrderLimitParam
     * @return
     */
    Map<String, String[]> checkBuyLimit(CouponOrderLimitParam couponOrderLimitParam);
}
