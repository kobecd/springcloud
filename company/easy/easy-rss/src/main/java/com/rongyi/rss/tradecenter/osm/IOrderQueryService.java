...
public interface IOrderQueryService {
     ...
     * @throws Exception
     */
    public List<CartOrderDetailVO> getOrderDetailBatch(List<String> orderNoList) throws Exception;
     ...
     * @throws Exception
     */
    public List<OrderEventEntity> getOrderEventByTypeBatch(String type, List<String> orderNumList) throws Exception;

    /**
     * 根据订单号查询生成订单状态记录
     * @author zhuming
     * @date 2018/1/23 20:53
     * @param orderNo
     * @return
     * @throws Exception
     */
    public OrderStatusFormEntity selectOrderStatusByOrderNo(String orderNo)throws Exception;
}
