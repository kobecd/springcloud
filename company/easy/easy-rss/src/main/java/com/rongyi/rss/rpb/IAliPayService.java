...
public interface IAliPayService {
     ...
     * @param orderNo
     * @param payType
     * @param aliConfigureVo
     * @return
     * @throws TradePayException
     */
    Map<String,Object> aliReverseOrder(String orderNo, Integer payType, AliConfigureVo aliConfigureVo)throws TradePayException;
