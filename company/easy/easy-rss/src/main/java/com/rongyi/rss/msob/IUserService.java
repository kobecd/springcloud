...
public interface IUserService {
    ...
    * @throws Exception
    ...
    /**
     * 根据用户昵称，用户UUID获取(增加限制查正常用户，is_disabled=0)
     * @param flag  标识位
     * @param strName  0 查昵称 1查UUID
     * @author zhuming
     * @date 2017/11/9
     * @return
     */
    public RmmmUserInfoEntity getUsersEntityByStrNameNormal(int flag,String strName,String identity)throws MallShopException;
}
