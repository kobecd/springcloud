...
import com.rongyi.easy.roa.param.ROAShopSearchParam;
...
public interface ROAShopService {
	...
	ResponseVO searchShopList(ROAShopSearchParam searchParam);

	ResponseVO getRecommendShops(ROAShopSearchParam searchParam);
}
