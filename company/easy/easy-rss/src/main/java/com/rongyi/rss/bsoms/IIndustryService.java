...
public interface IIndustryService {
	...
	/**
	 * 分页查询版本数据
	 * @param industryVersionParam
	 * @return
	 * @throws Exception
	 */
	PagingVO<?> searchVersionList(IndustryVersionParam industryVersionParam) throws Exception;
	...
	BIndustryVersion getVersionIndustryById(Integer id);

	List<BIndustry> getIndustryList()throws Exception;
}
