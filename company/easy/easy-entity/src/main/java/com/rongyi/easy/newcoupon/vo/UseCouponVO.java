...
import com.rongyi.easy.newcoupon.dto.TimePlugin;
...
public class UseCouponVO extends BaseVO {
     ...
     * 指定店铺
     */
    private List<ShopVO> shopDTOList;

    /**
     * 指定分类
     */
    private List<ShopCategoryVO> shopCategoryList;
     ...
     * 指定品类
     */
    private List<CommodityCategoryVO> commodityCategoryList;
