...
public class ShopVO implements Serializable {
	...
	public String toString() {
		return "ShopVO [id=" + id + ", name=" + name + ", shopNature="
				+ shopNature + ", shopType=" + shopType + ", number=" + number
				+ ", brand=" + brand + ", brands=" + brands + ", icon=" + icon
				+ ", categories=" + categories + ", exclusiveCategories="
				+ exclusiveCategories + ", tags=" + tags + ", mallName="
				+ mallName + ", mallId=" + mallId + ", businessDistrictId="
				+ businessDistrictId + ", businessDistrictName="
				+ businessDistrictName + ", areaVOs=" + areaVOs + ", address="
				+ address + ", moreFloors=" + moreFloors + ", shopNumber="
				+ shopNumber + ", businessStatus=" + businessStatus
				+ ", businessHours=" + businessHours + ", photoUrls="
				+ photoUrls + ", openedTime=" + openedTime + ", telephone="
				+ telephone + ", headName=" + headName + ", headTelephone="
				+ headTelephone + ", description=" + description + ", valid="
				+ valid + ", reason=" + reason + ", createdAt=" + createdAt
				+ ", updateBy=" + updateBy + ", updatedAt=" + updatedAt
				+ ", filialeName=" + filialeName + ", changeAble=" + changeAble
				+ ", nameEn=" + nameEn + ", descriptionEn=" + descriptionEn
				+ ", isEdit=" + isEdit + ", isShowInWeiXin=" + isShowInWeiXin
				+ ", sort=" + sort + ", location=" + location + "]";
	}
