...
public class PoiDocument implements Serializable {
	...
	@Field("custom_sort")
	private Integer custom_sort;  //店铺排序字段

	@Field("candidate_shop")
	private Boolean candidate_shop;

	@Field("new_shop")
	private Boolean new_shop;

	@Field("featured_shop")
	private Boolean featured_shop;
	...
	public Boolean getCandidate_shop() {
		return candidate_shop;
	}

	public void setCandidate_shop(Boolean candidate_shop) {
		this.candidate_shop = candidate_shop;
	}

	public Boolean getNew_shop() {
		return new_shop;
	}

	public void setNew_shop(Boolean new_shop) {
		this.new_shop = new_shop;
	}

	public Boolean getFeatured_shop() {
		return featured_shop;
	}

	public void setFeatured_shop(Boolean featured_shop) {
		this.featured_shop = featured_shop;
	}
	...
	public PoiDocument(ShopEntity shop) {
		...
		if(shop.getSort() != null){
			custom_sort = shop.getSort();
		}

		candidate_shop = shop.getCandidateShop();
		new_shop = shop.getNewShop();
		featured_shop = shop.getFeaturedShop();
		acronym = shop.getAcronym();
	}
	...
	public Integer getCustom_sort() {
		return custom_sort;
	}

	public void setCustom_sort(Integer custom_sort) {
