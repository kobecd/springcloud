...
public class SessionUserInfo implements Serializable{
    ...
    private String terminalType;//终端类型:1 容易逛,2 微信,3 终端机,4 小程序,多个以逗号隔开
    private Integer defaultTerminal;//默认终端 1 容易逛,2 微信,3 终端机，4 小程序
	...
	private Boolean displayAdTemplate;         //是否显示广告
