...
import com.rongyi.easy.coupon.entity.szc.SzcCoupon;
...
public class Coupon implements Serializable {
    ...
    private SzcCoupon szcCoupon;

    //单用户每天限购
    private Integer dayBuyLimit;

    public Integer getDayBuyLimit() {
        return dayBuyLimit;
    }

    public void setDayBuyLimit(Integer dayBuyLimit) {
        this.dayBuyLimit = dayBuyLimit;
    }
    ...
    public SzcCoupon getSzcCoupon() {
		return szcCoupon;
	}

	public void setSzcCoupon(SzcCoupon szcCoupon) {
		this.szcCoupon = szcCoupon;
	}
