...
public class FloorVO implements Serializable {
	...
	public String toString() {
		return "FloorVO [id=" + id + ", name=" + name + ", buildingName="
				+ buildingName + ", systemStatus=" + systemStatus
				+ ", position=" + position + ", navigationPic=" + navigationPic
				+ ", pathImg=" + pathImg + ", picture=" + picture + ", swfPic="
				+ swfPic + ", fmap=" + fmap + ", aliasename=" + aliasename
				+ ", aliasname=" + aliasname + ", tmap=" + tmap
				+ ", thirdFloorId=" + thirdFloorId + ", configFile="
				+ configFile + ", parentIds=" + parentIds + ", parentId="
				+ parentId + "]";
	}
