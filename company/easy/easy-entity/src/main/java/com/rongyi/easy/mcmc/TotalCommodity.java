...
public class TotalCommodity implements  Serializable,Cloneable{
	...
	public void wrapTotalCommodityInfo(Commodity commodity, com.rongyi.easy.mcmc.vo.CommodityVO vo) {
		...
		this.setPostageTemplateId(commodity.getPostageTemplateId());
		this.setWeight(commodity.getWeight());
	...
	public void wrapTotalCommodityInfo(Commodity commodity) {
		...
		this.setPostageTemplateId(commodity.getPostageTemplateId());
		this.setWeight(commodity.getWeight());
		this.setLandingPageType(commodity.getLandingPageType());
		this.setLandingPageUrl(commodity.getLandingPageUrl());
	}
	...
	public void setTotalCommodityFromParam(CommodityParam param, SessionUserInfo userInfo, Map<String, Object> skus) {
		try {
			...
			this.setOperationCategorys(param.getOperationCategorys());
	...
	public int hashCode() {
		...
		int result = 1;
		result = prime * result
				+ ((brandMid == null) ? 0 : brandMid.hashCode());
		result = prime
				* result
				+ ((commodityModelNo == null) ? 0 : commodityModelNo.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TotalCommodity other = (TotalCommodity) obj;
		if (brandMid == null) {
			if (other.brandMid != null)
				return false;
		} else if (!brandMid.equals(other.brandMid))
			return false;
		if (commodityModelNo == null) {
			if (other.commodityModelNo != null)
				return false;
		} else if (!commodityModelNo.equals(other.commodityModelNo))
			return false;
		if (name == null) {
			if (other.name != null)
				return false;
