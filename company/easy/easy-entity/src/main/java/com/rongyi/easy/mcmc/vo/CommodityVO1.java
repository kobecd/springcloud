...
public class CommodityVO1 implements Serializable {
    ...
    private Integer shopSort = 0;//店铺商品排序
    private List<List<String>> tags = new ArrayList<>();//标签名称列表
    private List<String> tagIds = new ArrayList<>();//标签Ids
    private Integer stock = 0;//库存
    private String commodityId;//分店商品ID
