...
public class MemberCenterModuleVO implements Serializable {
	...
	public String toString() {
		return "MemberCenterModuleVO [id=" + id + ", name=" + name + ", icon="
				+ icon + ", localIcon=" + localIcon + ", iconPress="
				+ iconPress + ", localIconPress=" + localIconPress + ", sort="
				+ sort + ", isDefault=" + isDefault + "]";
	}
