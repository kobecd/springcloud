...
public class ActivityGroupDetailVO implements Serializable{
	...
	private Integer activityCommodityHistoryStock;//活动商品历史库存总数
	...
	public Integer getActivityCommodityHistoryStock() {
		return activityCommodityHistoryStock;
	}

	public void setActivityCommodityHistoryStock(Integer activityCommodityHistoryStock) {
		this.activityCommodityHistoryStock = activityCommodityHistoryStock;
	}
	...
	public String toString() {
		return "ActivityGroupDetailVO{" +
				...
				", ifOpenGroup=" + ifOpenGroup +
				", ifJoinGroup=" + ifJoinGroup +
				", activityGroupDesc='" + activityGroupDesc + '\'' +
				", groupNum=" + groupNum +
				", groupPeopleMax=" + groupPeopleMax +
				", activityType=" + activityType +
				", activityRoundId='" + activityRoundId + '\'' +
				", ifSupportAdjustPrice=" + ifSupportAdjustPrice +
				", expectTotalAmount='" + expectTotalAmount + '\'' +
				", mallName='" + mallName + '\'' +
				", activityCommodityHistoryStock=" + activityCommodityHistoryStock +
				'}';
	}
}
