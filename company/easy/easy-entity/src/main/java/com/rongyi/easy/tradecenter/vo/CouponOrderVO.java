...
public class CouponOrderVO implements Serializable{
    ...
    /**
     * 卡券系统的版本 add by lianglaibin@2018-05-21
     */
    private Integer couponSysVersion;
    /**
     * 卡券名称 add by lianglaibin@2018-05-21
     */
    private String couponName;

    private String mallLogoUrl;
    private Integer couponType;
    private Date codeExpiryAt;
    ...
    public Date getCodeExpiryAt() {
        return codeExpiryAt;
    }

    public void setCodeExpiryAt(Date codeExpiryAt) {
        this.codeExpiryAt = codeExpiryAt;
    }
    ...
    public String toString() {
        return "CouponOrderVO [id=" + id + ", orderNo=" + orderNo + ", buyerId=" + buyerId + ", buyerName=" + buyerName
                + ", buyerMobile=" + buyerMobile + ", mallId=" + mallId + ", openId=" + openId + ", tradeStatus="
                + tradeStatus + ", orderTime=" + orderTime + ", payTime=" + payTime + ", tradeWay=" + tradeWay
                + ", cashCouponCode=" + cashCouponCode + ", paymentNo=" + paymentNo + ", devId=" + devId
                + ", payAccount=" + payAccount + ", totalAmount=" + totalAmount + ", payAmount=" + payAmount
                + ", discountAmount=" + discountAmount + ", itemList=" + itemList + ", discountInfo=" + discountInfo
                + ", nextStatusTime=" + nextStatusTime + ", statusHold=" + statusHold + ", checkCoupons=" + checkCoupons
                + ", couponId=" + couponId + ", couponSysVersion=" + couponSysVersion + ", couponName=" + couponName
                + ", mallLogoUrl=" + mallLogoUrl + ", couponType=" + couponType + ", codeExpiryAt=" + codeExpiryAt
