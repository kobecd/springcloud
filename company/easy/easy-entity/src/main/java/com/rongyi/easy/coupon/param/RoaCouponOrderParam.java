...
public class RoaCouponOrderParam implements Serializable {
    ...
    private Boolean needRegiste=null; //终端机手机号领取的，是否需要注册
    ...
    public static RoaCouponOrderParam build(String params) {
        ...
        if (map.get("needRegiste") != null) {
            param.setNeedRegiste(Boolean.getBoolean(map.get("needRegiste").toString()));
        }

        return param;
    }

    public Boolean getNeedRegiste() {
        return needRegiste;
    }
