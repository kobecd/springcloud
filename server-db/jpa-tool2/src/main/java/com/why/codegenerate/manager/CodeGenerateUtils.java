...
import com.why.codegenerate.model.ColumnClass;
...
public class CodeGenerateUtils {
     ...
     * @param basePath    需要生成包的路径 如user包需要生成在下面的包中"D:\testproject\back\src\main\java\com\why\greenhouse\back";
     * @param basePackage 基础报名 如user包在   com.why.greenhouse.back下
     * @return 当前类对象
     */
