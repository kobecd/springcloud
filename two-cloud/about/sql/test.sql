...
CREATE TABLE `t_blog_user_detail`  (
  ...
  `update_date` timestamp(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户详细信息扩展表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_sys_log`  (
  ...
  `success` tinyint(4) NULL DEFAULT NULL COMMENT '状态码成功与否',
